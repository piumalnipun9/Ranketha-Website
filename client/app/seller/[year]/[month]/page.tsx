...
import { DollarSign, ShoppingBag, Calendar, Package, ArrowLeft } from "lucide-react"
import {
    Table,
    TableBody,
    TableCell,
...
export default function SellerMonthlyPage() {
    ...
    useEffect(() => {
        const loadMonthlyData = async () => {
            try {
                // Fetch all orders and filter by month
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-slate-600">Monthly sales report and order details</p>
                    </div>
                </div>
                                            ...
                                            <TableRow key={order.id}>
                                                ...
                                                <TableCell>
                                                    <div className="flex flex-col">
                                                        <span className="text-slate-900">{order.user?.name || "Guest"}</span>
